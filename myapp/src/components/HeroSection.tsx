...
const HeroSection = () => {
  ...
  return (
    <div className="px-2 font-['poppins'] sm:w-[68vw] w-[62vw] md:w-[70vw]  justify-between py-5 flex-row flex ">
      <div className="flex flex-col gap-4 lg:gap-6">
        ...
        <motion.p
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 1 }}
          className="text-sm md:text-md w-[50vw] xl:text-lg"
        >
        ...
        onClick={()=>router.push('/login')}
          ...
          className="flex cursor-pointer hover:bg-gradient-to-br from-blue-300 to-white w-fit mt-4 rounded-md border px-2 border-zinc-800"
        >
          <ArrowRight />
